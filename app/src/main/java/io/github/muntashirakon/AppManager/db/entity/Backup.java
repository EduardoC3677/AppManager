...
public class Backup {
    ...
    public boolean equals(Object o) {
        ...
        return userId == backup.userId && packageName.equals(backup.packageName) && backupName.equals(backup.backupName);
    }
    ...
    public static Backup fromBackupMetadata(BackupMetadataV2 metadata) {
    ...
    public static Backup fromBackupMetadataV5(BackupMetadataV5 metadata) {
        return fromBackupInfoAndMeta(metadata.info, metadata.metadata);
    }

    public static Backup fromBackupInfoAndMeta(BackupMetadataV5.Info info, BackupMetadataV5.Metadata metadata) {
        Backup backup = new Backup();
        backup.packageName = metadata.packageName;
        backup.backupName = metadata.backupName == null ? "" : metadata.backupName;
        backup.label = metadata.label;
